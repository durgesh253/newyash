...
const Ecommerce = () => {
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-16 px-4 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        <div className="max-w-4xl mx-auto text-center my-[38px]">
      ...
      <section className="py-16 px-4 bg-[#00003f]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-slate-50 p-20 rounded-3xl">
            <div className="rounded-2xl">
              <img alt="AI Voice Agents" className="w-sm h-auto rounded-lg" src="/images/ecommerce.png" />
            </div>
